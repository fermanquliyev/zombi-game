    ...
    <section v-else-if="uiState === 'characterChosen'">
      ...
      <div class="zombietalk">
        <p
          ...
          class="character-choices"
        >
          <button @click="giveAnswer(character)">
...
export default defineComponent({
  ...
  methods: {
    pickCharacter() {
      store.commit("pickCharacter", this.characterInput);
      store.commit("updateUiState", "characterChosen");
    },
    giveAnswer(character: string): void {
      store.commit("giveAnswer", character);
    },
...
body {
  ...
  background: url("./assets/graphics/background.svg") no-repeat center center
      scroll,
    #29abe2;
}
